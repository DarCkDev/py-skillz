import {
  IsString, IsNumber, ValidateIf, IsArray, ValidateNested,
...
export class CreateEjercicioExaDto {
  ...
  @ValidateIf(o => o.tipo==='quiz') @IsString()
  respuestasString?: string;
  @ValidateIf(o => o.tipo==='codigo') @IsString()
  codigoBase?: string;
  @ValidateIf(o => o.tipo==='codigo') @IsString()
  resultadoEsperado?: string;
  @ValidateIf(o => o.tipo==='codigo') @IsString()
  feedbackSugerido?: string;
  @ValidateIf(o => o.tipo==='link') @IsString()
  url?: string;
